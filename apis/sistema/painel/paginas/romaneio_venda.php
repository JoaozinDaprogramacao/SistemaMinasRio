				...
				<div class="resumo-tabela">
					...
					<div class="resumo-linha radio">
						<div class="radio-group" style="display: block !important; ">
							<label>
								<input type="radio" name="option" value="adicional" onchange="adicionalAtivado()">
								Adicional
							</label>
							<label>
								<input type="radio" name="option" value="desconto" onchange="descontoAtivado()">
								Desconto
							</label>
						</div>
						<input type="text" placeholder="Descrição" name="descricao" id="descricao">
						<input type="text" placeholder="Valor" id="valor" name="valor" step="0.01" onkeyup="mascara_decimal('valor'); calcularValorDA();">
					</div>
					<div class="resumo-linha">
						<div class="resumo-celula">VALOR LIQUIDO A RECEBER</div>
