...
<div class="justify-content-between">
	<div class="left-content mt-2 mb-3">
		<a class="btn ripple btn-primary text-white" onclick="inserir()" type="button"><i class="fe fe-plus me-2"></i> Adicionar Material</a>
			...
			<form id="form_itens">
				<div class="modal-body">
					...
					<div class="row">
						<div class="col-md-4 mb-2 col-6">
							<label>Estoque</label>
							<input type="number" class="form-control" id="estoque" name="estoque" placeholder="Número de Materiais no estoque" required>
						</div>
						<div class="col-md-4 mb-2 col-6">
							<label>Estoque Mínimo</label>
							<input type="number" class="form-control" id="estoque_minimo" name="estoque_minimo" placeholder="Estoque mínimo para alerta" required>
						</div>
					</div>
