	...
	<div class="row">
		...
		<div class="col-md-3" >	
			<div class="form-group">			
				<select class="form-select sel2" id="funcionario" name="funcionario" style="width:100%;" onchange="listar()"> <option value="">Filtrar Funcionário</option>
				<?php 
				
				if($nivel_usuario == 'Administrador' || $nivel_usuario == 'Gerente'){
					
					$query = $pdo->query("SELECT * FROM usuarios where comissao > 0 order by nome asc");
