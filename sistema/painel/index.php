...
if (@$_GET['pagina'] != "") {
	$pagina = @$_GET['pagina'];
	echo '<script>console.log("Página: ' . $pagina . '")</script>';
} else {
	$pagina = $pag_inicial;
}
					...
					<div class="main-header-left ">
						<div class="responsive-logo">
							<a href="index.php" class="header-logo">
								<img src="../img/foto-painel.png" class="mobile-logo logo-1" alt="logo" style="width:40%; margin-left: -120px !important">
								<img src="../img/foto-painel.png" class="mobile-logo dark-logo-1" alt="logo" style="width:40%; margin-left: 50px !important">
							</a>
						</div>
									...
									<li class="dropdown nav-item  main-header-message <?php echo $receber ?>">
										...
										<div class="dropdown-menu">
											...
											<div class="main-message-list chat-scroll">
												...
												<?php
												if ($mostrar_registros == 'Não') {
													$query = $pdo->query("SELECT * from receber where vencimento < curDate() AND (pago IS NULL OR pago != 'Sim')  and usuario_lanc = '$id_usuario' order by id asc");
												} else {
													$query = $pdo->query("SELECT * from receber where vencimento < curDate() AND (pago IS NULL OR pago != 'Sim')  order by id asc");
												}
												$res = $query->fetchAll(PDO::FETCH_ASSOC);
												$linhas = @count($res);
												for ($i = 0; $i < $linhas; $i++) {
				...
				<aside class="app-sidebar">
					...
					<div class="main-sidemenu">
						...
						<ul class="side-menu">
							...
							<li class="slide <?php echo @$menu_romaneio ?>">
								<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
									<i class="fa-solid fa-list"></i>
									<span class="side-menu__label" style="margin-left: 15px">Romaneios</span><i class="angle fe fe-chevron-right"></i></a>
								<ul class="slide-menu">
							...
							<li class="slide <?php echo @$menu_romaneio_detalhes ?>">
								...
								<ul class="slide-menu">
									...
									<li class="<?php echo @$produtos ?>"><a class="slide-item" href="comissao_vendas"> Comissão Vendas</a></li>
								</ul>
							</li>
							...
							<li class="slide <?php echo @$menu_produtos ?>">
								...
								<ul class="slide-menu">
									...
									<li class="<?php echo @$tipo_caixa ?>"><a class="slide-item" href="tipo_caixa"> Tipo de Caixa</a></li>
							...
							<li class="slide <?php echo @$menu_vendas ?>">
								...
								<ul class="slide-menu">
									...
									<li class="<?php echo @$materiais ?>"><a class="slide-item" href="materiais"> Materials</a></li>

									<li class="<?php echo @$detalhes_materiais ?> "><a class="slide-item" href="detalhes_materiais"> Detalhes Materiais</a></li>
							...
							<li class="slide <?php echo @$menu_financeiro ?>">
								...
								<ul class="slide-menu">
									...
									<li class="<?php echo @$bancos ?> "><a class="slide-item" href="bancos"> Bancos</a></li>

									<li class="<?php echo @$detalhes_bancos ?> "><a class="slide-item" href="detalhes_bancos"> Bancos Detalhes</a></li>
									...
									<!--<li class="<?php echo @$dre ?> ocultar_mobile_app"><a class="slide-item" href="rel/dre.php?token=A5030" target="_blank"> DRE</a></li>
									-->
								</ul>
							</li>
			...
			<form method="POST" action="rel/financeiro_class.php" target="_blank">
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-4">
							<label>Tipo Lançamentofin</label>
