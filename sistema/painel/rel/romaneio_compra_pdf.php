...
<head>
  ...
  <style>
    * { margin:0; padding:0; box-sizing:border-box; font-family:Arial,sans-serif; font-size:10px; }
    ...
    .col-unit { width:15%; }
    .col-valor { width:15%; }
    .total-bruto td, .total-liquido td { background:#C5E0B3; font-weight:bold; }
    ...
    .assinatura { margin:20px auto 0; border-top:1px solid #000; width:200px; text-align:center; padding-top:5px; }
  </style>
</head>
<body>
