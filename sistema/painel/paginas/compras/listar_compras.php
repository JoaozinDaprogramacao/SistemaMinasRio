...
<style>
	...
	.controles-produto {
		...
		gap: 10px;
		flex-wrap: wrap;
		/* Permite que os controles quebrem a linha se não couberem */
	}
...
<script type="text/javascript">
	...
	function excluirItem(id) {
		$.ajax({
			...
			success: function(msg) {
				(msg.trim() == "Excluído com Sucesso") ? listarCompras(): alert(msg);
			}
		});
	}
	...
	function diminuir(id, quantidade) {
		$.ajax({
			...
			success: function(msg) {
				(msg.trim() == "Atualizado com Sucesso" || msg.trim() == "Excluído com Sucesso") ? listarCompras(): alert(msg);
			}
		});
	}
	...
	function aumentar(id, quantidade) {
		$.ajax({
			...
			success: function(msg) {
				(msg.trim() == "Atualizado com Sucesso") ? listarCompras(): alert(msg);
			}
		});
	}
