<div class="card-group" style="margin-bottom: 10px">
    <div class="card text-center mb-3" style="border-radius: 10px; height:110px; margin-right: 10px;">
        <a class="text-white" href="#" onclick="$('#tipo_data_filtro').val('Vencidas'); buscar();">
            <div class="card-header bg-red border-light">
                Vencidas <i class="fa fa-external-link pull-right"></i>
            </div>
            <div class="card-body">
                <h4 class="mt-n2"><span class="text-danger" id="total_vencidas">R$ 0,00</span></h4>
            </div>
        </a>
    </div>

    <div class="card text-center mb-3" style="border-radius: 10px; height:110px; margin-right: 10px;">
        <a href="#" onclick="$('#tipo_data_filtro').val('AVencer'); buscar();">
    ...
    <div class="card text-center mb-3" style="border-radius: 10px; height:110px; margin-right: 10px;">
        <a href="#" onclick="$('#tipo_data_filtro').val('Pagas'); buscar();">
            <div class="card-header border-light text-white" style="background: #2b7a00">
                Pagas <i class="fa fa-external-link pull-right"></i>
            </div>
            <div class="card-body">
                <h4 class="mt-n2"><span style="color: #2b7a00" id="total_pagas">R$ 0,00</span></h4>
            </div>
        </a>
    </div>

    <div class="card text-center mb-3" style="border-radius: 10px; height:110px;">
        <a href="#" onclick="$('#tipo_data_filtro').val('Todas'); buscar();">
            <div class="card-header border-light text-white" style="background: #08688c;">
                Total <i class="fa fa-external-link pull-right"></i>
            </div>
            <div class="card-body">
                <h4 class="mt-n2"><span id="total_total">R$ 0,00</span></h4>
            </div>
        </a>
    </div>
</div>
...
<div class="row px-2">
    ...
    <div class="col-md-6 px-1">
        <div class="card text-center mb-3" style="border-radius: 8px; background-color: #f8f9fc; border: 1px dashed #e74a3b; height: 60px;">
            <div class="card-body p-2">
                <small class="text-danger d-block text-uppercase font-weight-bold" style="font-size: 0.7rem;">Total Líquido</small>
                <span class="text-danger" id="total_liquido" style="font-size: 1.3rem; font-weight: 800;">R$ 0,00</span>
            </div>
        </div>
    </div>
</div>
