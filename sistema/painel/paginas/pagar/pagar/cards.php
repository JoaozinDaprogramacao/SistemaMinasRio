<div class="card-group" style="margin-bottom: -30px">
    ...
    <div class="card text-center mb-5" style="width: 100%; margin-right: 10px; border-radius: 10px; height:110px">
        <a class="text-white" href="#" onclick="$('#tipo_data_filtro').val('Vencidas'); $('#pago').val('Não'); buscar(); ">
    ...
    <div class="card text-center mb-5" style="width: 100%; margin-right: 10px; border-radius: 10px; height:110px">
        <a href="#" onclick=" $('#tipo_data_filtro').val('Pagas'); $('#pago').val('Sim'); buscar();">
            ...
            <div class="card-body">
                <p class="card-text" style="margin-top:-15px;">
                    <h4><span style="color: #2b7a00" id="total_pagas">R$ 0,0</span></h4>
                </p>
            </div>
        </a>
    </div>
