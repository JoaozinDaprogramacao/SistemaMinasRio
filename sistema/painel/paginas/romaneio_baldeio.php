...
<div class="justify-content-between">
    <form action="rel/receber_class.php" target="_blank" method="POST">
        <div class="left-content mt-2 mb-3">
            <a style="margin-bottom: 10px; margin-top: 5px" class="btn ripple btn-primary text-white" onclick="inserir()" type="button"><i class="fe fe-plus me-2"></i>Lançar Baldeio</a>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-8 mb-2">
                            ...
                            <select class="form-select" id="id_romaneio" name="id_romaneio" required>
                                <option value="">Selecione um Romaneio</option>
                                <?php
                                $query = $pdo->query("SELECT rv.*, c.nome as nome_cliente 
                                ...
                                foreach($res as $row) {
                                    echo '<option value="'.$row['id'].'">
                                        Romaneio #'.$row['id'].' - '.$row['nome_cliente'].' - '.
                       ...
                       <div class="col-md-8 mb-2">
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <select class="form-select" id="id_produtor" name="id_produtor" required>
                                    ...
                                    foreach($res as $row) {
                                        echo '<option value="'.$row['id'].'">
                                            Fornecedor #'.$row['id'].' - '.$row['razao_social'].' - '.
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <select class="form-select" id="id_atacadista" name="id_atacadista" required>
                                    <option value="">Selecione um Fornecedor</option>
                                    <?php
                        ...
                        <div class="col-md-4 mb-2">
                            ...
                            <input type="text" class="form-control" id="total" name="total" 
                                placeholder="R$ 0,00" required onkeyup="mascara_moeda('total')">
                        </div>  
                        <div class="col-md-8 mb-2">
                            <label>Local *</label>
...
<script type="text/javascript">
    function mascara_moeda(valor) {
        ...
        valorAlterado = valorAlterado.replace(/(\d+)(\d{2})$/, "$1,$2"); // Adiciona a vírgula
        valorAlterado = valorAlterado.replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1."); // Adiciona os pontos
