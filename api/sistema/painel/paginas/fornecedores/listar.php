...
<td>
    ...
    '{$contato}', '{$site}', '{$comissao}', '{$plano_pgto_value}', '{$prazo_pgto_value}', '{$forma_pagamento_value}', '{$email}'
...
<script type="text/javascript">
	function editar(id, nome, razao_social, cnpj, ie, cpf, rg, rua, numero, bairro, cidade, cep, uf, complemento, contato, site, comissao, plano_pgto, prazo_pgto, forma_pgto, email) {
